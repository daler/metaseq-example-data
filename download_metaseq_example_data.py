...
if not os.path.exists(args.data_dir):
    os.system('mkdir -p %s' % args.data_dir)
...
bams = [
    (
        ...
        '13M',
        '8369c75f10adb3e2d8cc95a72c7818ee',
    ...
    (
        ...
        '37M',
        '17b338a3dec290922bd69a5bd4ee05d4',
        ('http://hgdownload.cse.ucsc.edu/goldenPath/hg19/encodeDCC/wgEncodeHai'
...
bais = [
    (
        '173K',
        '973c6fca324e0dbbb03847650b377136',
        os.path.join(
            args.data_dir,
...
bigwigs = [
    (
        ...
        '97K',
        '1f4aead6b6348347a3f583fe0e9b07b4',
        ('http://hgdownload.cse.ucsc.edu/goldenPath/hg19/encodeDCC/wgEncodeHai'
    ...
    (
        ...
        '831K',
        'b72569ce7d4e1141ea5685dad49d7cc2',
        ('http://hgdownload.cse.ucsc.edu/goldenPath/hg19/encodeDCC/wgEncodeHai'
...
DB = (
    '48M',
    '2b3c98a2058e3e14dbad18cf49a6dcbb',
    os.path.join(
        args.data_dir,
